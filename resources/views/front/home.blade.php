    ...
    <div id="fh5co-counter" class="fh5co-counters">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 text-center animate-box">
                    <span class="fh5co-counter js-counter" data-from="0" data-to="87" data-speed="3000"
                          data-refresh-interval="50"></span>
                    <span class="fh5co-counter-label">Aulas</span>
                </div>
                <div class="col-md-3 text-center animate-box">
                    <span class="fh5co-counter js-counter" data-from="0" data-to="18" data-speed="3000"
                          data-refresh-interval="50"></span>
                    <span class="fh5co-counter-label">Horas</span>
                </div>
                <div class="col-md-3 text-center animate-box">
                    <span class="fh5co-counter js-counter" data-from="0" data-to="900" data-speed="3000"
                          data-refresh-interval="50"></span>
